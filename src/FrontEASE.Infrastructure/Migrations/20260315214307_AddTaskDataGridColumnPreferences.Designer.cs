...
namespace FrontEASE.Infrastructure.Migrations
{
    ...
    [Migration("20260315214307_AddTaskDataGridColumnPreferences")]
    partial class AddTaskDataGridColumnPreferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FrontEASE.Domain.Entities.Management.General.Columns.UserPreferenceGeneralOptionTaskGridColumn", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("UserPreferenceTaskDataGridColumns", "Data");
                });
            ...
            modelBuilder.Entity("FrontEASE.Domain.Entities.Tasks.Configs.TaskConfig", b =>
                {
                    ...
                    b.Property<int>("OptimizationGoal")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FrontEASE.Domain.Entities.Management.General.Columns.UserPreferenceGeneralOptionTaskGridColumn", b =>
                {
                    b.HasOne("FrontEASE.Domain.Entities.Management.General.UserPreferenceGeneralOptions", "GeneralOptions")
                        .WithMany("TaskGridColumns")
                        .HasForeignKey("GeneralOptionsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
