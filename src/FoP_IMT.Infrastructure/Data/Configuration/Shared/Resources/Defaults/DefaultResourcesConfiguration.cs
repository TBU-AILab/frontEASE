...
using FoP_IMT.Shared.Data.DTOs.Shared.Users.Auth;
using FoP_IMT.Shared.Data.DTOs.Tasks;
using FoP_IMT.Shared.Data.DTOs.Tasks.Data;
using FoP_IMT.Shared.Data.DTOs.Tasks.Data.Configs;
...
using FoP_IMT.Shared.Data.Enums.Tasks.Visualisation;
using FoP_IMT.Shared.Data.Enums.Users.Preferences.GeneralOptions;
using FoP_IMT.Shared.Data.Enums.Users.Visualisation;
...
namespace FoP_IMT.Infrastructure.Data.Configuration.Shared.Resources.Defaults
{
    public class DefaultResourcesConfiguration
    {
        ...
        private static IList<Resource> InitFieldResources()
        {
            ...
            [
                ...
                new Resource() { CountryCodeID = LanguageCode.EN, ResourceCode = AttributeExtensions.GetResourceFieldValue<LoginDto>(nameof(LoginDto.RememberMe), PropertyDisplayResourceType.FIELD), Value = "Remember me?" },
        ...
        private static IList<Resource> InitFieldPlaceholderResources()
        {
            ...
            [
                /* LoginDto */
                new Resource() { CountryCodeID = LanguageCode.EN, ResourceCode = AttributeExtensions.GetResourceFieldValue<LoginDto>(nameof(LoginDto.Username), PropertyDisplayResourceType.PLACEHOLDER), Value = "Big Joe" },
